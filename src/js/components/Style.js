export const BASIC_STYLE = {
  ...
  sources: {
    openmaptiles: {
      type: "vector",
      url: `https://api.maptiler.com/tiles/v3/tiles.json?key=XlHgx0sCh4pVd7QKzswE`
    },
    landcover: {
      type: "vector",
      url: `https://api.maptiler.com/tiles/landcover/tiles.json?key=XlHgx0sCh4pVd7QKzswE`
    },
  ...
  glyphs: `https://api.maptiler.com/fonts/{fontstack}/{range}.pbf?key=XlHgx0sCh4pVd7QKzswE`,
  layers: [
    {
      id: "background",
      type: "background",
